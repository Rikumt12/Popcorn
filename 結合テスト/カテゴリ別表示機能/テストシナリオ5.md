...
- 期待結果:
  ...
  5. 以下の内容を含む5つの商品が返却されていること（順不同）:
     - `{"productId": 1, "name": "ステンレスタンブラー", "price": 2800, "stock": 30, "imageUrl": "/images/tumbler.png"}`
     - `{"productId": 2, "name": "木製コースター（4枚セット）", "price": 1800, "stock": 50,"imageUrl": "/images/wooden-coaster.png"}`
     - `{"productId": 3, "name": "カトラリー", "price": 1600, "stock": 35, "imageUrl": "/images/katorari.png"}`
     - `{"productId": 4, "name": "エプロン", "price": 2000, "stock": 35, "imageUrl": "/images/epuronn.png"}`
     - `{"productId": 5, "name": "ガラス保存容器セット", "price": 1300, "stock": 20, "imageUrl": "/images/glass-container.png"}`
